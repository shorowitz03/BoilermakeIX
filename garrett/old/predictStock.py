...
#data normalization
column_indices = {name: i for i, name in enumerate(stockData.columns)}
n = len(stockData)
train_df = stockData[0:int(n*0.7)]
...
df_std = (stockData - train_mean) / train_std
df_std = df_std.melt(var_name='Column', value_name='Normalized')
# plt.figure(figsize=(12, 6))
# ax = sns.violinplot(x='Column', y='Normalized', data=df_std)
# _ = ax.set_xticklabels(stockData.keys(), rotation=90)
# plt.show()
...
#creates a tf dataset and trains it
